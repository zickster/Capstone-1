...
$stresults = mysqli_query($db, "SELECT id FROM tbl_pages WHERE p_title='$p_title'");
        ...
        $page_id=$srow['id'];
	mysqli_query($db, "INSERT INTO tbl_articles (art_name, art_text, art_type, an_sort, page_id, status) VALUES ('$art_name', '$art_text', '$art_file', '$an_sort', '$page_id', '$a_activate')");
               	mysqli_close($db);
