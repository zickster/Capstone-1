...
//Enter valid data into DB
		$password=md5($pass);
		mysqli_query($db, "INSERT INTO users (fname, lname, email, password, choice1, choice2, choice3, room_board, years, add1, add2, city, state, zip, phone, level, time_stamp) 
					      VALUES ('$fname', '$lname', '$email', '$password', '$choice1', '$choice2', '$choice3', '$rb', '$years', '$add1', '$add2', '$city', '$state', '$zip', '$phone', '$level', NOW())");
               	mysqli_close($db);
...
<?php
//Retrive data from the DB and display
