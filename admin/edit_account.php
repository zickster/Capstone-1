...
//Enter valid data into DB
		mysqli_query($db, "UPDATE users SET fname='$fname', lname='$lname', email='$email', choice1='$choice1', choice2='$choice2', choice3='$choice3', room_board='$rb', years='$years', add1='$add1', add2='$add2', city='$city', state='$state', zip='$zip', phone='$phone', level='$level' WHERE id='$id'");
               	mysqli_close($db);
...
<div class="container">
 ...
 <form method="post" action="<?php echo $PHP_SELF;?>">
        <table border="1" class="table">
                <tr>
<?php 
$tresults = mysqli_query($db, "SELECT * FROM users WHERE id='$id'");
