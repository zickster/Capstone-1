...
// Place it into your "../images" folder mow using the move_uploaded_file() function
...
if (!file_exists("../images/$fileName")) {
    ...
    echo "Check folder permissions on the target ../images folder is 0755 or looser.<br /><br />";
